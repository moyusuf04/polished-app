...
export default function AccountHeader({ insightsProvided = 14 }: AccountHeaderProps) {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="md:hidden mt-8 pt-8 border-t" style={{ borderColor: TOKENS.hairline }}>
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="font-sans font-light text-xs text-white/50">Insights Archived<br/>by Professionals</span>
            </div>
        </div>
